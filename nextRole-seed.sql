...
VALUES ('Conservator, furniture', 110000, 0, 'watson-davis'),
       ...
       ('Accountant', 175000, 0, 'stone-stewart'),
       ...
       ('Ads account executive', NULL, 0, 'thomas-sons'),
       ...
       ('Ads account executive', 130000, 0.064, 'thomas-sons'),
       ...
       ('Accountant ', 86000, 0.070, 'boyd-evans'),
       ...
       ('Account Manager', 126000, NULL, 'mejia-scott-ryan');
